...
public class Client{
   ...
   // JButton btnDescribe = new JButton("Describe");
    ...
    public Client() {
        ...
        //pnlButtons.setLayout(new GridLayout(1,0));r
 	...
 	pnlButtons.add(btnRepeat);
        ...
        playerFrame.add(btnSetup);
        playerFrame.add(btnPlay);
        playerFrame.add(btnPause);
        playerFrame.add(btnFPlay);
 	playerFrame.add(btnRepeat);
        playerFrame.add(btnTeardown);
        
        btnSetup.setBounds(10,220,100,50);
        btnPlay.setBounds(120,220,100,50);
        btnPause.setBounds(240,220,100,50);
        btnFPlay.setBounds(360,220,100,50);
        btnRepeat.setBounds(480,220,100,50);
        btnTeardown.setBounds(600,220,100,50);
	...
	imm.add(iconLabel);
        ...
        //pnlButtons.setBounds(0,480,500,50);
       	pnlMain.setBackground(Color.BLUE);
       	imm.setBackground(Color.BLUE);
        ...
        playerFrame.setSize(new Dimension(800, 600));
